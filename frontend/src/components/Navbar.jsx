      ...
      <div className="flex gap-4 items-center">
        {!isAuthenticated ? (
          <>
            <Link
              to="/login"
              className="text-blue-500 hover:bg-blue-500 hover:text-white text-lg font-medium border border-blue-500 px-2 py-1 rounded transition-all duration-200 transform hover:scale-105"
            >
              Login
            </Link>
            <Link
